"""
Known Logitech device metadata used to scale LogiLite beyond a single mouse model.
...
# Seeded from LogiLite's own device catalog first, then extended with broader
