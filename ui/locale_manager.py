...
_TRANSLATIONS = {
    "en": {
        ...
        "mouse.connect_mouse_desc": "LogiLite will detect the active device, unlock button mapping, and enable the correct layout mode as soon as the mouse is available.",
        ...
        "mouse.add_app_dialog.desc": "Choose an app. LogiLite will switch to this profile when that app is focused.",
        ...
        "scroll.appearance_desc": "Choose whether LogiLite follows the system, stays light, or stays dark.",
        "scroll.system": "System",
        "scroll.light": "Light",
        "scroll.dark": "Dark",
        "scroll.startup": "Startup",
        "scroll.startup_desc": "Start LogiLite at login on supported desktop platforms, and choose whether the settings window opens on launch or LogiLite stays in the system tray.",
        "scroll.start_at_login": "Start at login",
        "scroll.start_minimized": "Start minimized",
        "scroll.check_for_updates": "Check for updates",
        "scroll.check_for_updates_desc": "Notify when a newer LogiLite release is available. Downloads and installation stay manual.",
        "scroll.update_idle": "LogiLite can check for new releases.",
        "scroll.update_available": "LogiLite %1 is available.",
        ...
        "scroll.update_ready": "Ready to install after LogiLite quits.",
        ...
        "scroll.update_manual": "A new LogiLite release is available. Download it from the release page and install manually.",
        "scroll.update_manual_windows": "A new LogiLite release is available. Download it from the release page and install manually on Windows.",
        "scroll.update_manual_macos": "A new LogiLite release is available. Download it from the release page and install manually on macOS.",
        "scroll.update_manual_linux": "A new LogiLite release is available. Download it from the release page and install manually on Linux.",
        ...
        "scroll.update_error_network_error": "LogiLite could not reach the update service. Try again later.",
        ...
        "scroll.update_error_permission_denied": "LogiLite does not have permission to prepare the update.",
        "scroll.update_error_file_error": "LogiLite could not write the update files.",
        ...
        "scroll.update_error_older_build": "LogiLite rejected an older update.",
        ...
        # Keyboard page
        "keyboard.title": "Keyboard Studio",
        "keyboard.subtitle": "Logitech keyboard control surface",
        "keyboard.refresh": "Refresh",
        "keyboard.connected": "Connected",
        "keyboard.not_connected": "Not connected",
        "keyboard.none": "No Logitech keyboard detected",
        "keyboard.status_ready": "Inventory ready",
        "keyboard.status_empty": "Waiting for a Logitech keyboard",
        "keyboard.transport": "Transport",
        "keyboard.product_id": "Product ID",
        "keyboard.vendor_id": "Vendor ID",
        "keyboard.firmware": "Firmware",
        "keyboard.devices": "devices",
        "keyboard.copy_inventory": "Copy inventory",
        "keyboard.action_keyboard_settings": "macOS Keyboard",
        "keyboard.action_keyboard_settings_desc": "Keys, repeat, shortcuts",
        "keyboard.action_karabiner_desc": "Device-specific remaps",
        "keyboard.action_options_desc": "Official Logitech stack",
        "keyboard.action_ghub_desc": "Gaming keyboard stack",
        "keyboard.devices_title": "Devices",
        "keyboard.empty_hint": "Connect by Bluetooth, Bolt, Unifying, or USB.",
        "keyboard.action_refresh_desc": "Scan now",
        "keyboard.driver_stack": "Driver Stack",
        "keyboard.action_bluetooth": "Bluetooth",
        "keyboard.action_bluetooth_desc": "Pairing and battery",
        "keyboard.action_copy": "Copy JSON",
        "keyboard.action_copy_desc": "Inventory snapshot",
        "keyboard.action_solaar_desc": "Linux Logitech manager",
        "keyboard.action_logiops_desc": "Linux HID++ driver",
        ...
        "key_capture.error.unsupported_key": "Choose a different key. %1 isn't available in LogiLite.",
        ...
        "tray.update_available": "LogiLite {version} is available. Open the release page to download it.",
        "tray.quit": "Quit LogiLite",
        "tray.tray_message": "LogiLite is running in the system tray. Click the icon to open settings.",

        # Accessibility dialog (macOS)
        "accessibility.title": "Accessibility Permission Required",
        "accessibility.text": (
            "LogiLite needs Accessibility permission to intercept "
            "mouse button events.\n\n"
            "macOS should have opened the System Settings prompt.\n"
            "Please grant permission, then restart LogiLite."
        ),
        "accessibility.info": "System Settings -> Privacy & Security -> Accessibility",
        "accessibility.banner_title": "Accessibility permission required",
        "accessibility.banner_desc": "Grant LogiLite permission so mouse buttons and gestures can be captured.",
        "accessibility.open_settings": "Open Settings",
        "accessibility.refresh_permission": "Refresh permission",

        # About dialog
        "about.title": "About LogiLite",
    ...
    "zh_CN": {
        ...
        "mouse.connect_mouse_desc": "LogiLite \u5c06\u68c0\u6d4b\u6d3b\u52a8\u8bbe\u5907\uff0c\u89e3\u9501\u6309\u952e\u6620\u5c04\uff0c\u5e76\u5728\u9f20\u6807\u53ef\u7528\u540e\u542f\u7528\u6b63\u786e\u7684\u5e03\u5c40\u6a21\u5f0f\u3002",
        ...
        "mouse.add_app_dialog.desc": "\u9009\u62e9\u4e00\u4e2a\u5e94\u7528\u3002\u5f53\u8be5\u5e94\u7528\u5904\u4e8e\u7126\u70b9\u65f6\uff0cLogiLite \u5c06\u5207\u6362\u5230\u6b64\u914d\u7f6e\u3002",
        ...
        "scroll.appearance_desc": "\u9009\u62e9 LogiLite \u662f\u8ddf\u968f\u7cfb\u7edf\u3001\u4fdd\u6301\u6d45\u8272\u8fd8\u662f\u4fdd\u6301\u6df1\u8272\u3002",
        "scroll.system": "\u7cfb\u7edf",
        "scroll.light": "\u6d45\u8272",
        "scroll.dark": "\u6df1\u8272",
        "scroll.startup": "\u542f\u52a8",
        "scroll.startup_desc": "\u5728\u53d7\u652f\u6301\u7684\u684c\u9762\u5e73\u53f0\u4e0a\u968f\u767b\u5f55\u542f\u52a8 LogiLite\uff0c\u5e76\u9009\u62e9\u542f\u52a8\u65f6\u662f\u5426\u6253\u5f00\u8bbe\u7f6e\u7a97\u53e3\u6216\u4ec5\u4fdd\u6301\u5728\u7cfb\u7edf\u6258\u76d8\u3002",
        "scroll.start_at_login": "\u5f00\u673a\u81ea\u542f\u52a8",
        "scroll.start_minimized": "\u542f\u52a8\u65f6\u6700\u5c0f\u5316",
        "scroll.check_for_updates": "\u68c0\u67e5\u66f4\u65b0",
        "scroll.check_for_updates_desc": "\u6709\u65b0\u7248 LogiLite \u53ef\u7528\u65f6\u901a\u77e5\u3002\u4e0b\u8f7d\u548c\u5b89\u88c5\u4ecd\u9700\u624b\u52a8\u5b8c\u6210\u3002",
        "scroll.update_idle": "LogiLite \u53ef\u4ee5\u68c0\u67e5\u65b0\u7248\u672c\u3002",
        "scroll.update_available": "LogiLite %1 \u53ef\u7528\u3002",
        "scroll.update_checking": "\u6b63\u5728\u68c0\u67e5\u66f4\u65b0...",
        "scroll.update_downloading": "\u6b63\u5728\u4e0b\u8f7d\u66f4\u65b0...",
        "scroll.update_verifying": "\u6b63\u5728\u9a8c\u8bc1\u66f4\u65b0...",
        "scroll.update_ready": "LogiLite \u9000\u51fa\u540e\u5373\u53ef\u5b89\u88c5\u3002",
        ...
        "scroll.update_manual": "\u6709\u65b0\u7248 LogiLite \u53ef\u7528\u3002\u8bf7\u4ece\u53d1\u5e03\u9875\u4e0b\u8f7d\u5e76\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_manual_windows": "\u6709\u65b0\u7248 LogiLite \u53ef\u7528\u3002\u8bf7\u4ece\u53d1\u5e03\u9875\u4e0b\u8f7d\u5e76\u5728 Windows \u4e0a\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_manual_macos": "\u6709\u65b0\u7248 LogiLite \u53ef\u7528\u3002\u8bf7\u4ece\u53d1\u5e03\u9875\u4e0b\u8f7d\u5e76\u5728 macOS \u4e0a\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_manual_linux": "\u6709\u65b0\u7248 LogiLite \u53ef\u7528\u3002\u8bf7\u4ece\u53d1\u5e03\u9875\u4e0b\u8f7d\u5e76\u5728 Linux \u4e0a\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_no_asset": "\u6b64\u7535\u8111\u6ca1\u6709\u53ef\u7528\u7684\u66f4\u65b0\u5305\u3002",
        "scroll.update_error": "\u65e0\u6cd5\u51c6\u5907\u66f4\u65b0\u3002",
        "scroll.update_error_check_first": "\u8bf7\u5148\u68c0\u67e5\u66f4\u65b0\u3002",
        "scroll.update_error_network_error": "LogiLite \u65e0\u6cd5\u8fde\u63a5\u66f4\u65b0\u670d\u52a1\u3002\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002",
        "scroll.update_error_metadata_missing": "\u66f4\u65b0\u4fe1\u606f\u5c1a\u672a\u51c6\u5907\u597d\u3002\u8bf7\u6253\u5f00\u53d1\u5e03\u9875\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_error_metadata_invalid": "\u65e0\u6cd5\u8bfb\u53d6\u66f4\u65b0\u4fe1\u606f\u3002\u8bf7\u6253\u5f00\u53d1\u5e03\u9875\u624b\u52a8\u5b89\u88c5\u3002",
        "scroll.update_error_permission_denied": "LogiLite \u6ca1\u6709\u51c6\u5907\u66f4\u65b0\u7684\u6743\u9650\u3002",
        "scroll.update_error_file_error": "LogiLite \u65e0\u6cd5\u5199\u5165\u66f4\u65b0\u6587\u4ef6\u3002",
        ...
        "scroll.update_error_older_build": "LogiLite \u5df2\u62d2\u7edd\u8f83\u65e7\u7684\u66f4\u65b0\u3002",
        ...
        "key_capture.error.unsupported_key": "\u8bf7\u9009\u62e9\u5176\u4ed6\u6309\u952e\u3002%1 \u5728 LogiLite \u4e2d\u4e0d\u53ef\u7528\u3002",
        ...
        "tray.update_available": "LogiLite {version} \u53ef\u7528\u3002\u8bf7\u6253\u5f00\u53d1\u5e03\u9875\u9762\u624b\u52a8\u4e0b\u8f7d\u3002",
        "tray.quit": "\u9000\u51fa LogiLite",
        "tray.tray_message": "LogiLite \u6b63\u5728\u7cfb\u7edf\u6258\u76d8\u4e2d\u8fd0\u884c\u3002\u70b9\u51fb\u56fe\u6807\u6253\u5f00\u8bbe\u7f6e\u3002",

        "accessibility.title": "\u9700\u8981\u8f85\u52a9\u529f\u80fd\u6743\u9650",
        "accessibility.text": (
            "LogiLite \u9700\u8981\u8f85\u52a9\u529f\u80fd\u6743\u9650\u4ee5\u62e6\u622a\u9f20\u6807\u6309\u952e\u4e8b\u4ef6\u3002\n\n"
            "macOS \u5e94\u5df2\u6253\u5f00\u7cfb\u7edf\u8bbe\u7f6e\u63d0\u793a\u3002\n"
            "\u8bf7\u6388\u4e88\u6743\u9650\uff0c\u7136\u540e\u91cd\u65b0\u542f\u52a8 LogiLite\u3002"
        ),
    ...
    "zh_TW": {
        ...
        "mouse.connect_mouse_desc": "LogiLite \u5c07\u5075\u6e2c\u6d3b\u52d5\u88dd\u7f6e\uff0c\u89e3\u9396\u6309\u9375\u5c0d\u6620\uff0c\u4e26\u5728\u6ed1\u9f20\u53ef\u7528\u5f8c\u555f\u7528\u6b63\u78ba\u7684\u7248\u9762\u914d\u7f6e\u6a21\u5f0f\u3002",
        ...
        "mouse.add_app_dialog.desc": "\u9078\u64c7\u4e00\u500b\u61c9\u7528\u7a0b\u5f0f\u3002\u7576\u8a72\u61c9\u7528\u7a0b\u5f0f\u8655\u65bc\u7126\u9ede\u6642\uff0cLogiLite \u5c07\u5207\u63db\u5230\u6b64\u8a2d\u5b9a\u6a94\u3002",
        ...
        "scroll.appearance_desc": "\u9078\u64c7 LogiLite \u662f\u8ddf\u96a8\u7cfb\u7d71\u3001\u4fdd\u6301\u6dfa\u8272\u9084\u662f\u4fdd\u6301\u6df1\u8272\u3002",
        "scroll.system": "\u7cfb\u7d71",
        "scroll.light": "\u6dfa\u8272",
        "scroll.dark": "\u6df1\u8272",
        "scroll.startup": "\u555f\u52d5",
        "scroll.startup_desc": "\u5728\u53d7\u652f\u63f4\u7684\u684c\u9762\u5e73\u53f0\u4e0a\u96a8\u767b\u5165\u555f\u52d5 LogiLite\uff0c\u4e26\u9078\u64c7\u555f\u52d5\u6642\u662f\u5426\u958b\u555f\u8a2d\u5b9a\u8996\u7a97\u6216\u50c5\u4fdd\u6301\u5728\u7cfb\u7d71\u5217\u3002",
        "scroll.start_at_login": "\u767b\u5165\u6642\u555f\u52d5",
        "scroll.start_minimized": "\u555f\u52d5\u6642\u6700\u5c0f\u5316",
        "scroll.check_for_updates": "\u6aa2\u67e5\u66f4\u65b0",
        "scroll.check_for_updates_desc": "\u6709\u65b0\u7248 LogiLite \u53ef\u7528\u6642\u901a\u77e5\u3002\u4e0b\u8f09\u548c\u5b89\u88dd\u4ecd\u9700\u624b\u52d5\u5b8c\u6210\u3002",
        "scroll.update_idle": "LogiLite \u53ef\u4ee5\u6aa2\u67e5\u65b0\u7248\u672c\u3002",
        "scroll.update_available": "LogiLite %1 \u53ef\u7528\u3002",
        "scroll.update_checking": "\u6b63\u5728\u6aa2\u67e5\u66f4\u65b0...",
        "scroll.update_downloading": "\u6b63\u5728\u4e0b\u8f09\u66f4\u65b0...",
        "scroll.update_verifying": "\u6b63\u5728\u9a57\u8b49\u66f4\u65b0...",
        "scroll.update_ready": "LogiLite \u9000\u51fa\u5f8c\u5373\u53ef\u5b89\u88dd\u3002",
        "scroll.update_installing": "\u6b63\u5728\u5b89\u88dd\u66f4\u65b0...",
        "scroll.update_installed": "\u66f4\u65b0\u5df2\u5b89\u88dd\u3002",
        "scroll.update_installed_version": "\u5df2\u66f4\u65b0\u5230 %1\u3002",
        "scroll.update_cancelled": "\u66f4\u65b0\u5df2\u53d6\u6d88\u3002",
        "scroll.update_manual": "\u6709\u65b0\u7248 LogiLite \u53ef\u7528\u3002\u8acb\u5f9e\u767c\u5e03\u9801\u4e0b\u8f09\u4e26\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_manual_windows": "\u6709\u65b0\u7248 LogiLite \u53ef\u7528\u3002\u8acb\u5f9e\u767c\u5e03\u9801\u4e0b\u8f09\u4e26\u5728 Windows \u4e0a\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_manual_macos": "\u6709\u65b0\u7248 LogiLite \u53ef\u7528\u3002\u8acb\u5f9e\u767c\u5e03\u9801\u4e0b\u8f09\u4e26\u5728 macOS \u4e0a\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_manual_linux": "\u6709\u65b0\u7248 LogiLite \u53ef\u7528\u3002\u8acb\u5f9e\u767c\u5e03\u9801\u4e0b\u8f09\u4e26\u5728 Linux \u4e0a\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_no_asset": "\u6b64\u96fb\u8166\u6c92\u6709\u53ef\u7528\u7684\u66f4\u65b0\u5957\u4ef6\u3002",
        "scroll.update_error": "\u7121\u6cd5\u6e96\u5099\u66f4\u65b0\u3002",
        "scroll.update_error_check_first": "\u8acb\u5148\u6aa2\u67e5\u66f4\u65b0\u3002",
        "scroll.update_error_network_error": "LogiLite \u7121\u6cd5\u9023\u63a5\u66f4\u65b0\u670d\u52d9\u3002\u8acb\u7a0d\u5f8c\u91cd\u8a66\u3002",
        "scroll.update_error_metadata_missing": "\u66f4\u65b0\u8cc7\u8a0a\u5c1a\u672a\u6e96\u5099\u597d\u3002\u8acb\u958b\u555f\u767c\u5e03\u9801\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_error_metadata_invalid": "\u7121\u6cd5\u8b80\u53d6\u66f4\u65b0\u8cc7\u8a0a\u3002\u8acb\u958b\u555f\u767c\u5e03\u9801\u624b\u52d5\u5b89\u88dd\u3002",
        "scroll.update_error_permission_denied": "LogiLite \u6c92\u6709\u6e96\u5099\u66f4\u65b0\u7684\u6b0a\u9650\u3002",
        "scroll.update_error_file_error": "LogiLite \u7121\u6cd5\u5beb\u5165\u66f4\u65b0\u6a94\u6848\u3002",
        ...
        "scroll.update_error_older_build": "LogiLite \u5df2\u62d2\u7d55\u8f03\u820a\u7684\u66f4\u65b0\u3002",
        ...
        "key_capture.error.unsupported_key": "\u8acb\u9078\u64c7\u5176\u4ed6\u6309\u9375\u3002%1 \u5728 LogiLite \u4e2d\u7121\u6cd5\u4f7f\u7528\u3002",
        ...
        "tray.update_available": "LogiLite {version} \u53ef\u7528\u3002\u8acb\u958b\u555f\u767c\u5e03\u9801\u9762\u624b\u52d5\u4e0b\u8f09\u3002",
        "tray.quit": "\u7d50\u675f LogiLite",
        "tray.tray_message": "LogiLite \u6b63\u5728\u7cfb\u7d71\u5217\u4e2d\u57f7\u884c\u3002\u9ede\u64ca\u5716\u793a\u958b\u555f\u8a2d\u5b9a\u3002",

        "accessibility.title": "\u9700\u8981\u8f14\u52a9\u4f7f\u7528\u6b0a\u9650",
        "accessibility.text": (
            "LogiLite \u9700\u8981\u8f14\u52a9\u4f7f\u7528\u6b0a\u9650\u4ee5\u6514\u622a\u6ed1\u9f20\u6309\u9375\u4e8b\u4ef6\u3002\n\n"
            "macOS \u61c9\u5df2\u958b\u555f\u7cfb\u7d71\u8a2d\u5b9a\u63d0\u793a\u3002\n"
            "\u8acb\u6388\u4e88\u6b0a\u9650\uff0c\u7136\u5f8c\u91cd\u65b0\u555f\u52d5 LogiLite\u3002"
        ),
