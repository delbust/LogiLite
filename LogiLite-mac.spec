...
environment supports it:
    python3 -m PyInstaller LogiLite-mac.spec --noconfirm
"""
...
GENERATED_ICON = os.path.join(ROOT, "build", "macos", "LogiLite.icns")
...
if os.path.exists(COMMITTED_ICON):
    ...
    ICON_PATH = None
BUNDLE_ID = "io.github.delbust.logilite"
...
app = BUNDLE(
    ...
    info_plist={
        "CFBundleDisplayName": "LogiLite",
        "CFBundleName": "LogiLite",
